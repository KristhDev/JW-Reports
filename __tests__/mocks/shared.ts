...
import * as useVoiceRecorder from '@shared/hooks/useVoiceRecorder';
...
export const useVoiceRecorderSpy = jest.spyOn(useVoiceRecorder, 'default');
...
export const onNotRecordingMock = jest.fn();
export const onPressMock = jest.fn();
export const onRecordMock = jest.fn();
export const onSearchMock = jest.fn();
export const onSuccessMock = jest.fn();
export const onToggleMock = jest.fn();

export const startRecordingMock = jest.fn();
export const stopRecordingMock = jest.fn();