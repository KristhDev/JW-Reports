/* Mocks */
import { lessonEndpointMock } from './lessons';
...
/* Interfaces */
import { CourseEndpoint, CourseWithLessonsEndpoint } from '@infrasturcture/interfaces';
...
export const courseWithLessonsEndpointMock: CourseWithLessonsEndpoint = {
