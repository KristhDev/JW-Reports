...
/* Interfaces */
import { ReamainingOfHoursRequirement, RemainingHoursOfWeeklyRequirement } from '../interfaces';

export const report = {
    /**
     * Calculates the total hours worked in a week based on the given array of preachings.
     *
     * @param {PreachingEntity[]} preachingsOfWeek - An array of preaching objects representing the preachings of a week.
     * @return {string} The total hours worked in the week formatted as "hours:minutes".
     */
    getHoursDoneByWeek: (preachingsOfWeek: PreachingEntity[]): string => {
     ...
     */
    getReamainingOfHoursRequirement: (preachings: PreachingEntity[], hoursRequirement: number): ReamainingOfHoursRequirement => {
